...
class EditForm(Form):
	login = StringField('New user', validators=[DataRequired("Es requerido el login")])
	password = PasswordField('New password', validators=[DataRequired("Es requerido el password")])
	email = StringField('New correo electronico', validators=[DataRequired("Es requerido el correo electronico")])	